...
@WebServlet("/DisplayAdminForUser")
public class DisplayAdminForUser extends HttpServlet {
	AdminDao dao;
	@Override
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(admin.getName()!=null)
		{
			...
			request.getRequestDispatcher("CheckAdminForUser.html").include(request, response);
		}
	}
